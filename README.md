...
|------------|------------|-----------|-------------|
| [glyph](https://github.com/Bestdoom20/glyph) | 11 days ago | TypeScript | GLYPH — a living kaomoji face that replaces the '...' typing dots in any AI chat |
| [nexus-os](https://github.com/Bestdoom20/nexus-os) | 20 days ago | Python, TypeScript, CSS, JavaScript, Shell, HTML, Dockerfile | Mirror of Omvion-Automations/nexus-os |
| [omvion-website](https://github.com/Bestdoom20/omvion-website) | 22 days ago | HTML, JavaScript, CSS, Python, Shell | Direct mirror of Omvion-Automations/omvion-website (dev marketing site) |
| [snippets](https://github.com/Bestdoom20/snippets) | 27 days ago | Python | Small, reusable Python & shell utilities I reach for often. |
